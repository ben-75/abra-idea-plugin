    ...
    public void annotate(@NotNull final PsiElement element, @NotNull AnnotationHolder holder) {
        ...
        if (element instanceof AbraTypeName) {
            if(element.getParent().getParent().getParent() instanceof AbraFieldName){
                highlight(element,holder,AbraSyntaxHighlighter.ABRA_FIELD_DECLARATION);
            }else {
                highlight(element,holder,AbraSyntaxHighlighter.ABRA_TYPE_DECLARATION);
            }
        } else if (element instanceof AbraFuncName || element instanceof AbraFuncNameRef) {
            highlight(element,holder,AbraSyntaxHighlighter.ABRA_FCT_DECLARATION);
            ...
            if((element instanceof AbraVarName && (element.getParent() instanceof AbraStateExpr || element.getReference().resolve()!=null)) ||
                ...
                highlight(element,holder,AbraSyntaxHighlighter.ABRA_STATE_VAR_REFERENCE);
            }else {
                highlight(element,holder,AbraSyntaxHighlighter.ABRA_LOCAL_VAR);
            }
        } else if (element instanceof AbraLutName || element instanceof AbraLutNameRef ||
                (element instanceof AbraLutOrParamOrVarNameRef && (element.getReference().resolve() instanceof AbraLutName)) ) {
            highlight(element,holder,AbraSyntaxHighlighter.ABRA_LUT_DECLARATION);
            ...
            highlight(element,holder,AbraSyntaxHighlighter.ABRA_TEMPLATE_DECLARATION);
        }  else if (element instanceof AbraEnvironmentName ) {
            highlight(element,holder,AbraSyntaxHighlighter.ENV_NAME);
        } else if (element instanceof AbraEnvValue ) {
            highlight(element,holder,AbraSyntaxHighlighter.ENV_VALUE);
            ...
            highlight(element,holder,AbraSyntaxHighlighter.ABRA_TYPE_REFERENCE);
            ...
            highlight(element,holder,AbraSyntaxHighlighter.ABRA_TRIT);
        }
